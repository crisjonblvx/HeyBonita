...
- June 27, 2025. Fixed message sending errors and response truncation: resolved variable scope issues in chat mutation, upgraded from gpt-4o-mini to full gpt-4o model, increased token limits to 1200 for detailed mode (300 for quick mode), and added comprehensive logging to track response completion
