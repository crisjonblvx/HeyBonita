...
- June 27, 2025. Fixed message sending errors and response truncation: resolved variable scope issues in chat mutation, upgraded from gpt-4o-mini to full gpt-4o model, increased token limits to 1500 for detailed mode (500 for quick mode), made Bonita aware of her current response mode and token limits through dynamic system prompts, implemented automatic truncation detection with "Continue Response" button, and added comprehensive logging to track response completion
