...
- June 29, 2025. Implemented mobile audio context initialization for automatic speech: added pre-initialization of speech synthesis within user interaction context to enable automatic speech playback on mobile devices, fixed automatic speech triggering for both text-to-speech and speech-to-speech modes on mobile platforms, enhanced mobile audio timing with proper user interaction context establishment
